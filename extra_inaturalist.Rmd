...
```{r dados}
lente <- get_inat_obs_project("lente-ecologica-biodiversidade-do-norte-fluminense-03ec13fb-b9dc-4175-b47e-09dce7fa5848", type = "info", raw = FALSE)

# extrair registros
lente_obs <- get_inat_obs_project(lente$id, type = "observations")
