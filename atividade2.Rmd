...
1.  Para isso podemos utilizar a função `filter_name` do pacote `taxadb`. Esta função permite investigar os nomes em diferentes base de dados (e.g. GBIF, ITIS, COL etc.), mas neste caso vamos buscar na [*Integrated Taxonomic Information System*](https://www.itis.gov/) se a nomenclatura aplicada aos táxons é válida ou se necessita de atualização.
