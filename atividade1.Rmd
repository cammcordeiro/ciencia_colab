...
A atividade 1 consiste em transferir os dados indicados nas fichas de campo para o formato de planilha. As fichas encontram-se na pasta compartilhada do [Google Drive da disciplina](link_pasta).
...
3. Enviar a planilha para o email: `cammcordeiro@id.uff.br`
