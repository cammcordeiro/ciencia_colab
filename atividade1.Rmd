...
A atividade 1 consiste em transferir os dados indicados nas fichas de campo para o formato de planilha. As fichas encontram-se na pasta compartilhada do [Google Drive da disciplina](https://drive.google.com/drive/folders/1a1x8tgpXuw28rEm8CdUYaOJqJxcjLBVH?usp=sharing).
...
3.  Subir a planilha para no [drive compartilhado](https://drive.google.com/drive/folders/1iAFI9ptbPb8FMFm3NtxzMPkRUylysTBA?usp=sharing) na pasta **atividade1_data** dentro da pasta **atividades** (i.e. *Ciencia Colab/2025/aulas/planilhas/*).
